...
public class KeyHandler implements DeviceKeyHandler {
    private String TAG = "OPSettings-KeyHandler";
    ...
    private void doHapticFeedback() {
        ...
        boolean enabled = (int) Constants.getPreferenceValue(mContext.getApplicationContext(), Constants.TOUCHSCREEN_GESTURE_HAPTIC_FEEDBACK_KEY) == 1;
        if (enabled) {
